<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModificarCliente.aspx.cs" Inherits="_20220707_Parquadero.WebForm12" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="auto-style1">
                <tr>
                    <td class="auto-style35" colspan="7" style="font-family: 'trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; color: #FFFFFF; background-color: #808080">Modificar datos del cliente</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
